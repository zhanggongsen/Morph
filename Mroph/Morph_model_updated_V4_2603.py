...
class MorphModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG = networks.define_MorphNet(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
    ...
    def forward(self):
        if self.GNet == "Swin_Unetr":
            self.fake_E_1, self.fake_E_2, self.fake_E_3 = nn.Tanh(self.netG(torch.cat((self.real_I_1, self.real_I_2,self.real_I_3), 1),self.real_A,self.real_B,self.real_C) )
            # self.fake_E_1, self.fake_E_2, self.fake_E_3 = nn.Tanh(self.netG(torch.cat((self.real_I_1, self.real_I_2,self.real_I_3), 1),self.real_A,self.real_B,torch.cat((self.real_C, self.real_D), 1)) )
