...
def register_phases(patient_dir):
    ...
    for moving_phase in phases:
        moving_dir = os.path.join(patient_dir, f'Cropped_{moving_phase}')
        ...
        for fixed_phase in phases:
            ...
            fixed_dir = os.path.join(patient_dir, f'Cropped_{fixed_phase}')
            ...
            print(f"Patient: {os.path.basename(patient_dir)}, "
                  f"Moving_phase: Phase{moving_phase}, "
                  f"Fixed_phase: Phase{fixed_phase}", end="", flush=True)
            ...
            param_rigid["FixedImageDimension"] = ["3"]  # 3
            param_rigid["MovingImageDimension"] = ["3"]  # 3
            param_rigid["FixedInternalImagePixelType"] = ["float"]  # float
            param_rigid["MovingInternalImagePixelType"] = ["float"]  # float
            param_rigid["DefaultPixelValue"] = ["-1000"]  # CT background
            ...
            # param_rigid["WriteResultImage"] = ["false"]
            ...
            param_affine["FixedImageDimension"] = ["3"]  # 3
            param_affine["MovingImageDimension"] = ["3"]  # 3
            param_affine["FixedInternalImagePixelType"] = ["float"]  # float
            param_affine["MovingInternalImagePixelType"] = ["float"]  # float
            param_affine["DefaultPixelValue"] = ["-1000"]  # CT background
            ...
            # param_affine["WriteResultImage"] = ["false"]
            ...
            # param_bspline["WriteResultImage"] = ["false"]  # 默认: ["true"]
            param_bspline["LogToConsole"] = ["false"]  # 默认: ["true"]
            param_bspline["LogToFile"] = ["false"]  # 默认: ["true"]
...
def process_all_patients(root_dir):
