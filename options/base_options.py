...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='DosePrediction',
                            help='name of the experiment. It decides where to store samples and Mroph')

        parser.add_argument('--gpu_ids', type=str, default='-1',
                            help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for another GPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='Mroph are saved here')
        # model parameters
        ...
        parser.add_argument('--netG', type=str, default='UNet_3Plus',
                            help='specify generator architecture [resnet_2blocks | resnet_6blocks | unet_256 | unet_128| resnet_3blocks]')
        parser.add_argument('--deconv', type=int, default=0, help='specify deconv times : 0 or 1 ')
        ...
        parser.add_argument('--preprocess', type=str, default='none',
                            help='scaling and cropping of images at load time [resize_and_crop_rotate | crop_and_rotate| crop | scale_width | scale_width_and_crop | none]')
        ...
        parser.add_argument('--load_iter', type=int, default=0,
                            help='which iteration to load? if load_iter > 0, the code will load Mroph by iter_[load_iter]; otherwise, the code will load Mroph by [epoch]')
        ...
        parser.add_argument('--ifattention', type=str, default='False', help='use AG or CBAM attention')
    ...
    def gather_options(self):
        ...
        model_option_setter = Mroph.get_option_setter(model_name)
